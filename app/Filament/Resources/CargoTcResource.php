...
use App\Filament\Resources\CargoTcResource\Pages;
...
class CargoTcResource extends Resource
{
    protected static ?string $model = CargoTc::class;
    ...
    {
        return [
            'index' => Pages\ListCargoTcs::route('/'),
            'create' => Pages\CreateCargoTc::route('/create'),
            'edit' => Pages\EditCargoTc::route('/{record}/edit'),
        ];
    }
}
